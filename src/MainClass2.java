 ...
 *   	================================================================================
 *   	**인스턴스 변수             => 객체 생성	                     => 프로그램 종료시 까지     클래스 전체영역에서 사용 가능
 *   							 new=> 메모리 공간을 따로 생성                         
 *   	================================================================================
 ...
 *   							   javac	   java
 *   	==================================================================================
 *   	**지역변수					=> 메소드 호출 시마다			  	메소드가 종료하면 자동으로      메소드 영역내에서 사용가능
 *   													    사라진다
 *   	=====================================================================================
 *   
 *   	인스턴스 변수
 ...
 *   			데이터형 변수명;
 *   			데이터형 변수명;
 *   			static 데이터형 변수명; // 전역변수 => 클래스 전체에서 사용 변수, 멤버 변수
 *   			
 ...
 *   		void print(){
 *   			String name="박문수";  ========> stack ==> 우선순위 : 지역변수 > 멤버변수
